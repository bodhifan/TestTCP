...
namespace Common.Processor
{
   ...
   public delegate bool AccessHandler(Object sender, Object param);
    ...
    // 日志记录
   public delegate bool LogHandler(Object sender, string param);
    ...
    public class UIAccessProcessor
    {
        ...
        {
            LogHelper.Info("HandlerCompleted:" + currentRepeatTimes);
